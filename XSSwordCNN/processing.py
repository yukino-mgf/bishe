...
pre_datas_train="./file/pre_datas_train.txt"
pre_datas_test="./file/pre_datas_test.txt"
...
def pre_process():
    ...
    labels=to_categorical(labels) # one hot编码 0:[1,0] 1:[0,1]
    def to_index(data):
        d_index=[]
        for word in data:
    ...
    #向后补-1，长度统一maxlen
    datas_index=pad_sequences(datas_index,padding='post',truncating='post',value=-1)
    # 打乱分词与标签
