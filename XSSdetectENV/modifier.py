...
class Xss_modifier(object):
    def __init__(self):
        self.dim = 0
        self.name=""
        self.ACTION_TABLE = ['addComment','addTab','addZero','addEnter']
...
#常见免杀动作：
    ...
    def modify(self,str, action_number, seed=6):

        print("Do action :%s" % self.ACTION_TABLE[action_number])
        action_func=Xss_modifier().__getattribute__(self.ACTION_TABLE[action_number])
